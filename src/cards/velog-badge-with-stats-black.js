const createBadgeDark = (name, likes, views) => {
    ...
    return `
            <svg width="${total_size}" height="25" viewBox="0 0 ${total_size} 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M3.125 0H21.875C23.6009 0 25 1.39911 25 3.125V21.875C25 23.6009 23.6009 25 21.875 25H3.125C1.39911 25 0 23.6009 0 21.875V3.125C0 1.39911 1.39911 0 3.125 0Z" fill="black"/>
